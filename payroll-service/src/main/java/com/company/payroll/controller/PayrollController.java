...
public class PayrollController {
    ...
    // Delete salaries by employeeCode (used by employee-service during cascade delete)
    @DeleteMapping("/salaries/by-employee/{employeeCode}")
    @PreAuthorize("hasRole('HR')")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void deleteSalariesByEmployeeCode(@PathVariable String employeeCode) {
